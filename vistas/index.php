    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="card">
                    <div class="body thumbnail">
                        <img src="../public/images/puppy-2.jpg" class="img-fluid img-thumbnail" alt=" /">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="card">
                    <div class="body thumbnail">
                        <img src="../public/images/puppy-3.jpg" class="img-fluid img-thumbnail" alt="">
                        <div class="caption m-t-20">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="card">
                    <div class="body thumbnail">
                        <img src="../public/images/puppy-1.jpg" class="img-fluid img-thumbnail" alt="">
                        <div class="caption m-t-20">
