              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="input-group">
                      <div class="form-line">
                        <label for="cant_empleados">¿Cuántas personas trabajan en tu empresa?</label>
                        <select class="" name="cant_empleados" id="cant_empleados">
...
<!--Select 2 js-->
<script type="text/javascript" src='../plugins/select2/dist/js/select2.min.js'>
