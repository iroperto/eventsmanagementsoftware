...
<div id="morphsearch" class="morphsearch">
    ...
    <div class="morphsearch-content">
        <div class="dummy-column">
            <h2>People</h2>
            <a class="dummy-media-object" href="#"> <img class="round" src="../public/images/sm/avatar1.jpg" alt=""/>
            <h3>Sara Soueidan</h3>
          </a> <a class="dummy-media-object" href="#"> <img class="round" src="../public/images/sm/avatar2.jpg" alt=""/>
            <h3>Rachel Smith</h3>
          </a> <a class="dummy-media-object" href="#"> <img class="round" src="../public/images/sm/avatar3.jpg" alt=""/>
            <h3>Peter Finlan</h3>
          </a> <a class="dummy-media-object" href="#"> <img class="round" src="../public/images/sm/avatar4.jpg" alt=""/>
            <h3>Patrick Cox</h3>
          </a> <a class="dummy-media-object" href="#"> <img class="round" src="../public/images/sm/avatar5.jpg" alt=""/>
            <h3>Tim Holman</h3>
            </a></div>
        <div class="dummy-column">
            <h2>Popular</h2>
            <a class="dummy-media-object" href="#"> <img class="round" src="../public/images/sm/avatar5.jpg" alt=""/>
            <h3>Sara Soueidan</h3>
          </a> <a class="dummy-media-object" href="#"> <img class="round" src="../public/images/sm/avatar4.jpg" alt=""/>
            <h3>Rachel Smith</h3>
          </a> <a class="dummy-media-object" href="#"> <img class="round" src="../public/images/sm/avatar3.jpg" alt=""/>
            ...
            <h3>Patrick Cox</h3>
          </a> <a class="dummy-media-object" href="#"> <img class="round" src="../public/images/sm/avatar1.jpg" alt=""/>
            <h3>Tim Holman</h3>
            </a> </div>
        <div class="dummy-column">
            <h2>Recent</h2>
        ...
        <div role="tabpanel" class="tab-pane in active in active" id="chat">
                <div class="demo-settings">
                    ...
                    <ul>
                        <li class="online">
                            <div class="media">
                                <a  role="button" tabindex="0"> <img class="media-object " src="../public/images/xs/avatar1.jpg" alt=""> </a>
                        ...
                        <li class="online">
                            <div class="media"> <a  role="button" tabindex="0"> <img class="media-object " src="../public/images/xs/avatar2.jpg" alt=""> </a>
                                <div class="media-body">
                        ...
                        <li class="online">
                            <div class="media"> <a  role="button" tabindex="0"> <img class="media-object " src="../public/images/xs/avatar3.jpg" alt=""> </a>
                                <div class="media-body">
                    ...
                    <ul>
                        <li class="offline">
                            <div class="media"> <a  role="button" tabindex="0"> <img class="media-object " src="../public/images/xs/avatar4.jpg" alt=""> </a>
                                <div class="media-body">
                        ...
                        <li class="online">
                            <div class="media"> <a  role="button" tabindex="0"> <img class="media-object " src="../public/images/xs/avatar1.jpg" alt=""> </a>
                                <div class="media-body">
                                    <span class="name">Joel King</span> <span class="badge badge-outline status"></span>
                                </div>
                            </div>
                        ...
                        <li class="offline">
                            <div class="media"> <a class="pull-left " role="button" tabindex="0"> <img class="media-object " src="../public/images/xs/avatar2.jpg" alt=""> </a>
                                <div class="media-body">
                                    <span class="name">Joel King</span> <span class="badge badge-outline status"></span>
                                </div>
                            </div>
