...
<script src="../public/bundles/morphingsearchscripts.bundle.js"></script> <!-- Main top morphing search -->

<script src="../public/plugins/jquery-sparkline/jquery.sparkline.min.js"></script> <!-- Sparkline Plugin Js -->
<script src="../public/plugins/chartjs/Chart.bundle.min.js"></script> <!-- Chart Plugins Js -->
